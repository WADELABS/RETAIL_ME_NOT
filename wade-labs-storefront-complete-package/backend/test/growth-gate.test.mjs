...
const healthy = {
  trailingContributionCents: 300000n, afterMarketingMarginBps: 500,
  ...
  currentWeeklyRevenueCents: 1000000n,
};
...
test('healthy business expands weekly revenue by no more than policy cap', () => {
  ...
  assert.equal(result.maximumNextWeeklyRevenueCents, 1100000n);
});
